...
I’m a **Senior AI/LLM Engineer** with deep experience building practical AI systems that connect large language models, RAG, AI agents, APIs, CRM platforms, business data, and enterprise workflows into reliable automation teams can use every day.

My strongest background is in **LLM application development, RAG architecture, AI agents, structured outputs, function calling, enterprise workflow automation, CRM automation, API integration, document processing, data workflows, ecommerce automation, customer support AI, and reporting automation**.
